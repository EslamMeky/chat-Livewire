<div
    ...
    <header class="px-3 z-10 bg-gray-50 sticky top-0 w-full py-2">
...
{{--  Filters      --}}
        <div class="flex gap-3 items-center   p-2 bg-gray-50">
    ...
    <main class="overflow-y-scroll overflow-hidden grow h-full relative" style="contain: content">
        ...
        <ul class="p-2 grid w-full space-y-2">
            ...
            <li
                ...
                class="py-3 hover:bg-gray-100 rounded-2xl dark:hover:bg-gray-200 transition-colors duration-150 flex gap-4 relative w-full cursor-pointer px-2 {{$conversation->id ==$selectedConversation?->id?'bg-gray-100/70':'  '}} ">
                <a href="#" class="shrink-0">
                    <x-avater src="https://source.unsplash.com/500x500?face-{{$key}}" />
                </a>
                <aside class="grid grid-cols-12 w-full">
                  ...
                  {{--   message body--}}
                        <div class="flex gap-x-2 items-center">
                            ...
                            <p class="grow truncate text-sm font-">
                        ...
                        <x-dropdown align="right" width="48" >
                            ...
                            <x-slot name="content">
                                ...
                                <div class="w-full p-1" >
                                    <button class="items-center gap-3 flex w-full px-4 py-2 text-left text-sm leading-5  text-gray-500 hover:bg-gray-200 transition-all duration-150 ease-in-out focus:outline-none focus:bg-gray-200">
                                            <span>
                                    ...
                                    <button
                                        ...
                                        class="items-center gap-3 flex w-full px-4 py-2 text-left text-sm leading-5  text-gray-500 hover:bg-gray-200 transition-all duration-150 ease-in-out focus:outline-none focus:bg-gray-200">
                                            <span>
